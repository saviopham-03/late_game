...
namespace Unity.Collections
{
    ...
    public static partial class xxHash3
    {
        ...
        private static unsafe ulong Read64LE(void* addr)
        {
            byte* byte_addr = (byte*)addr;

            return (ulong)byte_addr[0] |
                  ((ulong)byte_addr[1] << 8) |
                  ((ulong)byte_addr[2] << 16) |
                  ((ulong)byte_addr[3] << 24) |
                  ((ulong)byte_addr[4] << 32) |
                  ((ulong)byte_addr[5] << 40) |
                  ((ulong)byte_addr[6] << 48) |
                  ((ulong)byte_addr[7] << 56);
        }

        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe uint Read32LE(void* addr)
        {
            byte* byte_addr = (byte*)addr;

            return (uint)byte_addr[0] |
                  ((uint)byte_addr[1] << 8) |
                  ((uint)byte_addr[2] << 16) |
                  ((uint)byte_addr[3] << 24);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe void Write64LE(void* addr, ulong value)
        {
            byte* byte_addr = (byte*)addr;
            byte_addr[0] = (byte)value;
            byte_addr[1] = (byte)(value >> 8);
            byte_addr[2] = (byte)(value >> 16);
            byte_addr[3] = (byte)(value >> 24);
            byte_addr[4] = (byte)(value >> 32);
            byte_addr[5] = (byte)(value >> 40);
            byte_addr[6] = (byte)(value >> 48);
            byte_addr[7] = (byte)(value >> 56);
        }
